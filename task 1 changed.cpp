...
ColumnVector approximation(ColumnVector& t, ColumnVector& b, int m, int n) {
...
int main() {
    ...
    ColumnVector coefficients = approximation(t, b, m, n);

    fprintf(pipe, "set yrange [0:25]\n");
    fprintf(pipe, "set xrange [0:22]\n");

    fprintf(pipe, "plot %lf*x**2 + %lf*x**1 + %lf*x**0 lc 'black', '-' with points pt 7 lc 'purple'\n",
